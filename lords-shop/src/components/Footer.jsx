        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.navHome')}</Link></li>
              <li><Link to="/accounts" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.navAccounts')}</Link></li>
              <li><Link to="/resources" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.navResources')}</Link></li>
              <li><Link to="/sapphires" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.navSpecial')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/guarantees" className="text-sm text-slate-400 hover:text-emerald-400 transition-colors flex items-center gap-2"><ShieldCheck className="w-4 h-4" /> {t('footer.clientGuarantees')}</Link></li>
              <li><Link to="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.clientTerms')}</Link></li>
              <li><Link to="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">{t('footer.clientPrivacy')}</Link></li>
            </ul>
          </div>
